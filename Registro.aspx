<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Login_InfoToolsSV.Registro" %>
                        ...
                        <div class="card bg-glass">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <div class="row" style="padding: 10px;">
                                    <asp:Button ID="BtnRegistrarse" CssClass="btn btn-primary btn-block mb-4" runat="server" Text="Registrarse" OnClick="BtnRegistrar_Click" />   
                                </div>
                                <div class="row" style="padding: 10px;">
                                    <asp:Button ID="BtnIngresar" CssClass="btn btn-primary btn-block mb-4 custom-btn" runat="server" Text="Ingresar" OnClick="BtnIrAIngresar_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
